...
for _n_estimators in x[0]:
    ...
    for _random_state in x[0]:
        ...
        model = GradientBoostingClassifier(n_estimators=_n_estimators)
        ...
        arrayKQ.append([accuracy, precison, recall, f1, end - begin, _random_state, _n_estimators])
...
# ket qua
accuracy, precison, recall, f1, time, _random_state, _n_estimators  = max_arr
print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
...
imgName = '192339-GradientBoostingClassifier-breast-cancer' + str((accuracy, precison, recall, f1)) + '.jpg'
import pyautogui
