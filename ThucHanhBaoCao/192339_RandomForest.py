...
x = random.randint(1, 150, size=(1, 100))

for _n_estimators in x[0]:
    for _random_state in x[0]:
        ...
        model = RandomForestClassifier(n_estimators=_n_estimators, n_jobs=5)
        ...
        arrayKQ.append([accuracy, precison, recall, f1, end - begin, _n_estimators, _random_state])
...
# ket qua
accuracy, precison, recall, f1, time, _n_estimators, _random_state = max_arr
print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
print("_n_estimators", _n_estimators)
...
imgName = '192339-RandomForestClassifier-breast-cancer' + str((accuracy, precison, recall, f1)) + '.jpg'
import pyautogui
