...
x = random.randint(1, 150, size=(1, 20))
...
for _kernel in ['linear', 'rbf']:
    ...
    for _C in x[0]:
        ...
        for _random_state in x[0]:
            ...
            arrayKQ.append([accuracy, precison, recall, f1, end - begin, _kernel, _C, _random_state])
...
# ket qua
accuracy, precison, recall, f1, time, _kernel, _C, _random_state = max_arr
print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
print("_kernel", _kernel)
print("_C", _C)
...
imgName = '192339-SVC-bupa' + str((accuracy, precison, recall, f1)) + '.jpg'
import pyautogui
